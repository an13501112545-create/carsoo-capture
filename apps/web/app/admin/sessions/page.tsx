...
export default function AdminSessionsPage() {
  ...
  const [notifications, setNotifications] = useState<SessionNotifications | null>(null);
            ...
            <div className="card" style={{ marginTop: '1rem' }}>
              ...
              {notifications.sms && (
                <div style={{ marginBottom: '0.75rem' }}>
                  <p><strong>SMS to:</strong> {notifications.sms.to || '-'}</p>
                  <p><strong>Message:</strong> {notifications.sms.message || '-'}</p>
                </div>
              )}
              {notifications.email && (
                <div>
                  <p><strong>Email to:</strong> {notifications.email.to || '-'}</p>
